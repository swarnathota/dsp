...
>> Twins being identical or not doesn't depend on each other, we can consider them as two independent events. Therefore, 
p(A) = p(B) = 0.5.
p(A and B) = 0.5 * 0.5 = 0.25
chance of Elvis was an identical twin is 1/300 * 0.25 = 1/1200.
